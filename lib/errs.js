...
//
export const create = function createErr(type, opts) {
  if (!arguments[1] && !registered[type]) {
    opts = type;
    type = null;
  }
  ...
  //
  ErrorProto = type && registered[type] || Error;
...
//
export const merge = function (err, type, opts) {
  var merged = create(type, opts);
...
//
export const register = function (type, proto) {
...
// `errors.create(type, opts)`.
//
export const unregister = function (type) {
